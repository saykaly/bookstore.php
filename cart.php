   ...
   <div class="box-container">
      ...
      if (mysqli_num_rows($select_cart) > 0) {
         while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
            $product_stock = $fetch_cart['stock']; // Assign the value of stock to $product_stock
            $sub_total = $fetch_cart['quantity'] * $fetch_cart['price']; // Calculate sub total
      ...
      <div class="box">
         ...
         <div class="stock">
            ...
            <?php } else { ?>
               <span style="color: red;">hurry, only <?php echo $product_stock; ?> left</span>
            <?php } ?>
         </div>
